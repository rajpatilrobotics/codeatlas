...
function extractFunctions(ast, filePath = 'unknown') {
  ...
  }); } catch (e) { console.error("Error traversing functions", e); }
...
function extractClasses(ast, filePath = 'unknown') {
  ...
  }); } catch (e) { console.error("Error traversing classes", e); }
...
function extractImports(ast, filePath = 'unknown') {
  ...
  }); } catch (e) { console.error("Error traversing imports", e); }
...
function extractExports(ast, filePath = 'unknown') {
  ...
  }); } catch (e) { console.error("Error traversing exports", e); }
...
function extractVariables(ast, filePath = 'unknown') {
  ...
  }); } catch (e) { console.error("Error traversing variables", e); }
